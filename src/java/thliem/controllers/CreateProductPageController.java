 ...
 * @author LiemNguyen
 */
public class CreateProductPageController extends HttpServlet {
    final org.apache.log4j.Logger LOG = org.apache.log4j.Logger.getLogger(CreateProductPageController.class);
    
    final private String CREATE_PAGE = "create-product.jsp";
